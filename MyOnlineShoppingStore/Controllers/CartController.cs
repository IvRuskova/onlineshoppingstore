...
using MyOnlineShoppingStore.Models.ViewModels.Cart;
using System;
...
namespace MyOnlineShoppingStore.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddCartPartial(int id)
        {
            //Init CartVM list
        ...
        public void PlaceOrder()
        {
            ...
            {
                Credentials = new NetworkCredential("4267d10c6f9003", "64f070bd13d8a4"),
                EnableSsl = true
            };
